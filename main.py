...
async def lifespan(
    ...
    print(
        "âœ“ Dashboard service connected"
    )
    ...
    try:
        ...
        print(
            "âœ“ DNS Server stopped"
        )

        print(
            "âœ“ SentinelDNS shutdown complete"
        )
